    ...
    <section className="py-20 md:py-24 relative overflow-hidden bg-muted/30">
      <div className="container px-4 mx-auto">
        <div className="text-center space-y-4 mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif font-bold">Curated Travel Experiences</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {categories.map((cat, i) => (
            <div
              key={i}
              className="bg-accent/10 p-6 sm:p-8 rounded-3xl shadow-sm border border-border/50 hover:shadow-xl transition-all hover:-translate-y-2 group"
            >
