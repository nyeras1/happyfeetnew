...
export function Loader() {
  return (
    <div className="loader-wrapper flex items-center justify-center min-h-screen bg-background">
      <div className="earth flex flex-col items-center">
        ...
        <p className="loader-text mt-4 text-lg font-semibold tracking-wide text-white">Connecting...</p>
      </div>
    </div>
  )
}
